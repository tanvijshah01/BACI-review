...
cbc_data <- read_csv(file.path(data_dir,'TanviShah_CBC_Data_Request', data_filename))

effort_data <- read_csv(file.path(data_dir, 'TanviShah_CBC_Data_Request', effort_filename)) %>% clean_names()
