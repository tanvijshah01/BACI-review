...
tanvishah@bren.ucsb.edu
7:18 PM (11 minutes ago)
to Tanvi
...
#### Snap function ####
#I use these two functions to snap sites to the nearest raster cell for the various covariates.
# Because R is slow, these functions involve exporting data and running part of the analysis in QGIS (all explained in functions)
